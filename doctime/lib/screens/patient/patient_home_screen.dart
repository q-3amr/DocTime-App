...
class _PatientHomeContentState extends State<PatientHomeContent> {
  ...
  void _showFeedbackPopup(BuildContext context, String appointmentId) {
    // Use a local rating variable managed inside StatefulBuilder so the
    // star widget can update without needing to call setState on the screen.
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              // Fetch the appointment doc to get doctor_id
                              ...
                              // Recalculate and persist the doctor's
                              // aggregate rating on their user document
